...
resource "google_cloud_run_service_iam_member" "allow-public-app-web_invoker" {
...
resource "google_cloud_run_service_iam_member" "allow-public-app-api_invoker" {
...
resource "google_cloud_run_service_iam_member" "allow-public-app-docs-v1_invoker" {
  service  = google_cloud_run_v2_service.app-docs-v1.name
  location = var.GCP_REGION
  role     = "roles/run.invoker"
  member   = "allUsers"
}

resource "google_cloud_run_service_iam_member" "allow-public-app-images-v1_invoker" {
  service  = google_cloud_run_v2_service.app-images-v1.name
  location = var.GCP_REGION
  role     = "roles/run.invoker"
  member   = "allUsers"
}

resource "google_cloud_run_service_iam_member" "allow-public-app-pdf-v1_invoker" {
  service  = google_cloud_run_v2_service.app-pdf-v1.name
  location = var.GCP_REGION
  role     = "roles/run.invoker"
  member   = "allUsers"
}
