...
from app_pdf.views.v1.base_logic.pdf_split import (
...
@v1_view_pdf_router_openai.post(
	...
	description=(
			...
			"and responds with a download link with a Zip file containing "
			"multiple PDF files, each containing one page from the input PDF. "
			"Max upload PDF file size is 10MB, and download link expires in 5 "
			"minutes."
	),
	summary="Split PDF into multiple 1 page PDFs. Returns a Zip file",
)
async def view_pdf_split_openai(
		request: Request,
