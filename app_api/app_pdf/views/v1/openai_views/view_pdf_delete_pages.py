...
@v1_view_pdf_router_openai.post(
	...
	description=(
			...
			"and a string of comma separated numbers for the pages to remove, "
			"and responds with a download link for the output PDF file. Max PDF "
			"file size is 10MB, and download link expire in 5 minutes."
	),
	summary="Delete pages from PDF",
)
async def view_pdf_delete_pages_openai(
		request: Request,
