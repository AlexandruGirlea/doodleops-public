...
from app_pdf.views.v1.base_logic.pdf_password_management_add import (
...
@v1_view_pdf_router_openai.post(
	...
	description=(
			...
			"Needs a mandatory password parameter. If no password ask user for "
			"one. Responds with a download link for the output PDF file. "
			"Max PDF file size is 10MB, and download link expires in 5 minutes."
	),
	summary="Add password to PDF",
)
async def view_pdf_password_management_add_openai(
		request: Request,
