...
from app_pdf.cloud_run_container_app_pdf.v1.schemas.view_pdf_rotate import (
	InputPDFRotate
)


APP_NAME, VERSION, API = "app_pdf", "v1", "view_pdf_rotate"
...
async def get_cloud_run_response(
		...
		pages_to_rotate_right: str, pages_to_rotate_left: str,
		pages_to_rotate_upside_down: str
):
	try:
		InputPDFRotate(
