...
def research_node(state: State) -> Command[Literal["research_node"]]:
	...
	perplexity_response = perplexity_search(
		system_msg=f"""
		You are an intelligent Learning research assistant. Be direct, friendly,
		and provide concise responses.
		
		Based on the latest user prompt and the full conversation context, search
		the internet to help the user in his learning journey. Provide relevant
		...
		- study tips
		- answers to general knowledge questions based on the user's knowledge
		needs
