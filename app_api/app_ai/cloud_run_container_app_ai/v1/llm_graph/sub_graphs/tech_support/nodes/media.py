...
media_template = PromptTemplate(
	...
	template="""
		You are a friendly and helpful AI tech agent. Your job is to help
		help the user in his problem.
...
def media_node(state: State) -> Command[Literal["media_node"]]:
	...
	msg, cost = get_media_response_img_or_pdf(
		media_input=dict_resp, language=language,
