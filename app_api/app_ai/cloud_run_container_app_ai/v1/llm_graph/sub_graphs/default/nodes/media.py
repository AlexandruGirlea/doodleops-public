...
default_media_template = PromptTemplate(
	input_variables=["history", "new_message", "language", "format_instructions"],
	template="""
		You are a friendly and helpful general purpose AI assistant.
...
extract_requirements_chain = (
	default_media_template | base_llm_vertexai | output_parser
)
